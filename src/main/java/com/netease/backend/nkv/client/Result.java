...
public class Result<T> {
	public static class ResultCode {
		...
		public static ResultCode MEMBERNOTEXISTS = new ResultCode(2, "member not exist");
		...
		public static ResultCode EXISTS = new ResultCode(-3966, "data already exist");
		...
		static {
			...
			ResultCode.regist(ResultCode.EXISTS);
	...
	public boolean isLocked() {
		return (this.flag  & NkvConstant.NKV_ITEM_FLAG_LOCKED) != 0;
	}
	
	public boolean hasNext() {
		return (this.flag  & NkvConstant.NKV_ITEM_FLAG_HAS_NEXT) != 0;
	}
	
	public boolean isCounter() {
		return (this.flag & NkvConstant.NKV_ITEM_FLAG_ADDCOUNT) != 0;
	}
