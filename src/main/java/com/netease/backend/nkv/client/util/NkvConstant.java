...
public class NkvConstant {
	...
	public static int NKV_ITEM_FLAG_ADDCOUNT = 1;
	public static int NKV_ITEM_FLAG_DELETED = 2;
	public static int NKV_ITEM_FLAG_ITEM = 4;
	public static int NKV_ITEM_FLAG_LOCKED = 8;
	public static int NKV_ITEM_FLAG_HAS_NEXT = 8;

	public static short NKV_STYPE_MIXEDKEY = 12;
	public static short NKV_STYPE_BYTEARRAY = 9;
	public static final int NKV_STYPE_INCDATA = 11;
    ...
    public static final String FIELD_NOT_AVAILABLE = "field is not available";
